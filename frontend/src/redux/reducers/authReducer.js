...
export const authReducer = (
  ...
  switch (action.type) {
    ...
    case userConstants.LOGIN_WITH_REQUEST:
    ...
    case authConstants.REFRESH_TOKEN_REQUEST: // ? Refresh token request
      return {
        ...state,
        loading: false,
      };
    ...
    case authConstants.REFRESH_TOKEN_SUCCESS: // ? Refresh token success
      return {
        ...state,
        loading: false,
        isAuthenticated: true,
