    ...
    public function check_meeting($id)
    {
        try {
            ...
            $participent = [
                ...
                'image' => self::getPrivateS3File($participent_detail->image),
    ...
    public function endMeeting($id)
    {
        try {
            ...
            if (!empty($meeting)) {
                ...
                return response()->json(['res' => 'success', 'type' => 'success', 'message' => 'Meeting has been ended.']);
            } else {
